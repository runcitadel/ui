...
export const { styled, css, globalCss, keyframes, getCssText, theme, createTheme, config } = Stitches.createStitches({
	theme: {
		colors: {
			dark: '#162127',
			light: '#E5ECF1',
		...
		fonts: {
			untitled: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", sans-serif',
