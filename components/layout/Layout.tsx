...
export function Layout({ children, css }: { children: JSX.Element | JSX.Element[]; css?: CSS }) {
	...
	return (
		...
		>
			...
			<span className="text-6xl font-bold">Tailwind works if this is big and bold! </span>
		</Flex>
	)
}
