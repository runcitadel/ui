...
export function Dialog(props: DialogProps) {
	const { title = 'Dialog Title', submitText = 'Submit', triggerText = 'Open Dialog', handleSubmission } = props
				...
				<OverlayContainer>
					<Modal title={title} isOpen onClose={state.close} isDismissable>
						<Flex as="form" css={{ fd: 'column' }}>
							...
							<button {...closeButtonProps} ref={closeButtonRef} style={{ mt: 10 }} onClick={handleSubmission}>
								{submitText}
							</button>
						</Flex>
					</Modal>
